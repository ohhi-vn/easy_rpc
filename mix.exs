defmodule EasyRpc.MixProject do
  ...
  defp description() do
    "A library for wrapping rpc call from a remote nodes to call like local function. Easy to wrap a remote functions to a local functions (by declare config)."
  end
